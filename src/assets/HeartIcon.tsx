...
const HeartIcon = ({liked, onClick}: {liked?: boolean, onClick?: (e: React.MouseEvent<SVGSVGElement>) => void}) => {
  return (
      <svg onClick={onClick} className={`${styles.heart} ${liked && styles.liked} ` } tabIndex={0} viewBox="0 0 42 38" xmlns="http://www.w3.org/2000/svg">
